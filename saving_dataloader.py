...
def dataloader(sp = 100, model_name = "densenet121"):
    ...
    if not check_if_a_with_name_exisi(curretn_path,f'train_dataloader_{sp}_{model_name}.pkl'):
        ...
        with open(f'train_dataloader_{sp}_{model_name}.pkl', 'rb') as f:
            train_loader = pickle.load(f)

        with open(f'test_dataloader_{sp}_{model_name}.pkl', 'rb') as f:
            test_loader = pickle.load(f)
        
        with open(f'val_dataloader_{sp}_{model_name}.pkl', 'rb') as f:
